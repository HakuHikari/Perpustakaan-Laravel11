...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    />
    <!-- Favicon-->
    <link rel="shortcut icon" href="landing/img/fav.png" />
    <!-- Author Meta -->
  ...
  <body>
    <header id="header" id="home">
      <div class="container">
        <div class="row align-items-center justify-content-between d-flex">
          <div id="logo">
            <a href="index.html"><img src="landing/img/logo.png" alt="" title="" /></a>
          </div>
          <nav id="nav-menu-container">
            <ul class="nav-menu">
              <li class="menu-active"><a href="#home">Home</a></li>
              @if (Route::has('login')) @auth
              <li><a href="{{ url('/dashboard') }}">About</a></li>
              @else
      ...
      <div class="container">
        ...
        >
          <div class="banner-content col-lg-7">
            ...
            <h1 class="text-uppercase">New Adventure</h1>
        ...
        <div class="row">
          <div class="active-course-carusel">
            <div class="single-course item">
              <img class="img-fluid" src="landing/img/c1.jpg" alt="" />
            ...
            <div class="single-course item">
              <img class="img-fluid" src="landing/img/c2.jpg" alt="" />
              <p class="sale-btn">For Sale</p>
              <div class="details">
                <a href="#"
                  ><h4>
            ...
            <div class="single-course item">
              <img class="img-fluid" src="landing/img/c3.jpg" alt="" />
              <p class="sale-btn">For Sale</p>
              <div class="details">
                <a href="#"
                  ><h4>
    ...
    <section class="call-to-action-area section-gap">
      <div class="container">
        ...
        <div class="row justify-content-center d-flex">
          <div
            class="download-button d-flex flex-row justify-content-center mt-30"
          >
        ...
        <div class="row">
          <div class="active-tstimonial-carusel">
            <div class="single-testimonial item">
              <img class="mx-auto" src="landing/img/t1.png" alt="" />
              <p class="desc">
            ...
            <div class="single-testimonial item">
              <img class="mx-auto" src="landing/img/t2.png" alt="" />
              <p class="desc">
                Accessories Here you can find the best computer accessory for
                your laptop, monitor, printer, scanner, speaker, projector,
                hardware and more. laptop accessory
            ...
            <div class="single-testimonial item">
              <img class="mx-auto" src="landing/img/t3.png" alt="" />
              <p class="desc">
                Accessories Here you can find the best computer accessory for
                your laptop, monitor, printer, scanner, speaker, projector,
                hardware and more. laptop accessory
    ...
    <script
      src="https://cdnjs.cloudflare.com/ajax/libs/popper.landing/js/1.12.9/umd/popper.min.js"
